package com.mojise.library.ax_designsystem.loading.modal
...
import com.mojise.library.ax_designsystem.R
import com.mojise.library.ax_designsystem.dialog.AxBasicDialogFragment.UiModel
import com.mojise.library.ax_designsystem.ext.getColorFromTheme
import com.mojise.library.ax_designsystem.loading.modal.customview.LoadingIndicatorView
import java.io.Serializable

private data class ViewBinding(
    val loadingIndicatorView: LoadingIndicatorView,
...
class AxModalLoadingDialogFragment : DialogFragment() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        uiModel = arguments
            ?.let { BundleCompat.getSerializable(it, ARGS_UI_MODEL, UiModel::class.java) }
            ?: run {
                Log.e(TAG, "onCreate :: uiModel is null")
                dismiss()
                return
            }
    }
    ...
    override fun onCreateDialog(
        ...
        setContentView(R.layout.dialog_ax_modal_loading)
    ...
    override fun onCreateView(
        ...
        container: ViewGroup?,
        savedInstanceState: Bundle?
    ): View = inflater.inflate(R.layout.dialog_ax_modal_loading, container, false).apply {
        binding = ViewBinding(
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        val loadingMessage = loadingMessageResId?.let {
            getString(it)
        } ?: getString(R.string.ax_ds_modal_loading_message_data_loading)

        binding.loadingMessage.text = loadingMessage
    }

    fun show(supportFragmentManager: FragmentManager) {
        if (isVisible.not() && isStateSaved.not()) {
    ...
    companion object {
        const val TAG = "AxModalLoadingDialogFragment"
